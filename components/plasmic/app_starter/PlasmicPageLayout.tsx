...
// Plasmic Project: m3kWKftbg8ZiXAzAk5pTSS
// Component: 76G7ss6N616L
...
import projectcss from "./plasmic_app_starter.module.css"; // plasmic-import: m3kWKftbg8ZiXAzAk5pTSS/projectcss
import sty from "./PlasmicPageLayout.module.css"; // plasmic-import: 76G7ss6N616L/css

import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: elr0M2LvJMKQ/icon
import Icon2Icon from "./icons/PlasmicIcon__Icon2"; // plasmic-import: COv3WaWihKXF/icon
...
function PlasmicPageLayout__RenderFunc(props: {
  ...
  return (
    <RichLayout
      ...
      logoElement={
        <Icon2Icon
          className={classNames(projectcss.all, sty.svg__vBxf1)}
          role={"img"}
        />
      }
      navMenuItems={(() => {
    ...
    >
      <LoadingBoundary
        ...
        loadingState={
          <ph.DataCtxReader>
            {$ctx => (
              <div className={classNames(projectcss.all, sty.freeBox__hHcMa)}>
                <IconIcon
                  className={classNames(projectcss.all, sty.svg__ahmw)}
                  role={"img"}
                />
              </div>
            )}
      ...
      >
        <ph.DataCtxReader>
          {$ctx => (
            <div className={classNames(projectcss.all, sty.freeBox__bdU7T)}>
              {p.renderPlasmicSlot({
                defaultContents: (
                  <section
                    className={classNames(projectcss.all, sty.section__eeEc3)}
                  >
                    <h1
                      className={classNames(
                        projectcss.all,
